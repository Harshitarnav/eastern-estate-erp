  ...
  async onModuleInit(): Promise<void> {
    ...
    try {
      ...
      const alterQueries = [
        ...
        `ALTER TABLE towers ADD COLUMN IF NOT EXISTS default_super_built_up_area DECIMAL(10,2);`,
        `ALTER TABLE towers ADD COLUMN IF NOT EXISTS default_built_up_area DECIMAL(10,2);`,
        `ALTER TABLE towers ADD COLUMN IF NOT EXISTS default_carpet_area DECIMAL(10,2);`,
        `ALTER TABLE towers ADD COLUMN IF NOT EXISTS flat_number_prefix VARCHAR(30);`,
