// Database Seed Script for Eastern Estate Properties
// Run this to populate the database with real EECD projects

export const propertiesSeedData = [
  {
...
export const generateSeedSQL = () => {
  const sql = propertiesSeedData.map(property => {
