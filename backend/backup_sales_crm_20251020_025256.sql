...
\restrict 1bVAaB6drcRrXzHJoqb9EOVMxOfXo9YZsfpDIcmyAuzqsN6VHZ6SySkE2v275Kb
...
CREATE TABLE public.bookings (
    ...
    token_receipt_number character varying(100),
    token_payment_mode character varying(100),
    ...
    loan_application_number character varying(100),
    loan_approval_date date,
    loan_disbursement_date date,
    nominee1_name character varying(200),
    nominee1_relation character varying(100),
    nominee2_name character varying(200),
    nominee2_relation character varying(100),
    co_applicant_name character varying(200),
    co_applicant_email character varying(200),
    co_applicant_phone character varying(20),
    co_applicant_relation character varying(100),
...
CREATE TABLE public.leads (
    ...
    referral_name character varying(200),
    referral_phone character varying(20),
    ...
    last_meeting_date timestamp without time zone,
...
COPY public.bookings (id, booking_number, customer_id, property_id, flat_id, booking_date, booking_amount, total_amount, paid_amount, balance_amount, status, payment_plan, possession_date, agreement_date, registry_date, is_home_loan, bank_name, loan_amount, loan_status, is_active, notes, metadata, created_at, updated_at, token_paid_date, token_receipt_number, token_payment_mode, agreement_number, agreement_signed_date, agreement_document_url, expected_possession_date, actual_possession_date, registration_date, discount_amount, discount_reason, stamp_duty, registration_charges, gst_amount, maintenance_deposit, parking_charges, other_charges, loan_application_number, loan_approval_date, loan_disbursement_date, nominee1_name, nominee1_relation, nominee2_name, nominee2_relation, co_applicant_name, co_applicant_email, co_applicant_phone, co_applicant_relation, cancellation_date, cancellation_reason, refund_amount, refund_date, documents, tower_id, special_terms, tags, created_by, updated_by) FROM stdin;
58369ae2-0b5b-4946-aa28-748f0bfc3fb0	BOOK-001	f1f70615-f977-4aa7-b448-f5636af8d83b	687c13c5-00ab-4e6e-ab5e-b53cc722e2a9	604d000c-ad34-4750-8b94-64d330796330	2025-01-15	500000.00	3800000.00	500000.00	3300000.00	CONFIRMED	\N	\N	\N	\N	f	\N	\N	\N	t	\N	\N	2025-10-16 11:49:23.195909	2025-10-16 11:49:23.195909	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
--
-- Name: idx_bookings_created_by; Type: INDEX; Schema: public; Owner: eastern_estate
--
...
--
-- Name: idx_bookings_token_payment_mode; Type: INDEX; Schema: public; Owner: eastern_estate
--

CREATE INDEX idx_bookings_token_payment_mode ON public.bookings USING btree (token_payment_mode);


--
-- Name: idx_bookings_tower_id; Type: INDEX; Schema: public; Owner: eastern_estate
--

CREATE INDEX idx_bookings_tower_id ON public.bookings USING btree (tower_id);
...
--
-- Name: idx_leads_assigned_at; Type: INDEX; Schema: public; Owner: eastern_estate
--

CREATE INDEX idx_leads_assigned_at ON public.leads USING btree (assigned_at);
...
--
-- Name: idx_leads_converted_at; Type: INDEX; Schema: public; Owner: eastern_estate
--
...
--
-- Name: idx_leads_created_by; Type: INDEX; Schema: public; Owner: eastern_estate
--
...
--
-- Name: bookings fk_booking_created_by; Type: FK CONSTRAINT; Schema: public; Owner: eastern_estate
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT fk_booking_created_by FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: bookings fk_booking_tower; Type: FK CONSTRAINT; Schema: public; Owner: eastern_estate
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT fk_booking_tower FOREIGN KEY (tower_id) REFERENCES public.towers(id) ON DELETE SET NULL;


--
-- Name: bookings fk_booking_updated_by; Type: FK CONSTRAINT; Schema: public; Owner: eastern_estate
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT fk_booking_updated_by FOREIGN KEY (updated_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: leads fk_lead_created_by; Type: FK CONSTRAINT; Schema: public; Owner: eastern_estate
--

ALTER TABLE ONLY public.leads
    ADD CONSTRAINT fk_lead_created_by FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: leads fk_lead_updated_by; Type: FK CONSTRAINT; Schema: public; Owner: eastern_estate
--

ALTER TABLE ONLY public.leads
    ADD CONSTRAINT fk_lead_updated_by FOREIGN KEY (updated_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
\unrestrict 1bVAaB6drcRrXzHJoqb9EOVMxOfXo9YZsfpDIcmyAuzqsN6VHZ6SySkE2v275Kb
