...
let SmsService = SmsService_1 = class SmsService {
    ...
    async sendSms(options) {
        ...
        if (!settings.enableSmsReminders) {
            this.logger.debug(`SMS feature flag is OFF - message to ${options.to} was NOT sent. ` +
                `Toggle company_settings.enable_sms_reminders to enable.`);
            return { accepted: false, skipped: true };
        }
        this.logger.warn(`SMS provider NOT configured - message to ${options.to} was NOT sent.`);
        return { accepted: false, skipped: true };
    }
};
