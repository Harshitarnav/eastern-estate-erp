...
import { FlatSalesStatusBreakdown, emptySalesBreakdown } from '../../properties/dto/property-inventory-summary.dto';
...
export declare const emptyFlatCompleteness: () => FlatCompletenessBreakdown;
export declare class FlatInventoryUnitDto {
    id: string;
    flatNumber: string;
    floor: number;
    type: FlatType;
