...
let TowersService = TowersService_1 = class TowersService {
    ...
    async formatTowerResponse(tower) {
        ...
        return {
            ...
            defaultSuperBuiltUpArea: tower.defaultSuperBuiltUpArea ?? null,
            defaultBuiltUpArea: tower.defaultBuiltUpArea ?? null,
            defaultCarpetArea: tower.defaultCarpetArea ?? null,
            flatNumberPrefix: tower.flatNumberPrefix ?? null,
