...
let BudgetsController = class BudgetsController {
    ...
    findAll(fiscalYear, status) {
        return this.budgetsService.findAll({
            fiscalYear: fiscalYear ? parseInt(fiscalYear) : undefined,
            status,
        });
    }
    getVarianceReport(fiscalYear) {
        return this.budgetsService.getBudgetVarianceReport(fiscalYear ? parseInt(fiscalYear) : undefined);
    }
    findOne(id) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], BudgetsController.prototype, "getVarianceReport", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_budget_dto_1.UpdateBudgetDto]),
    __metadata("design:returntype", void 0)
...
exports.BudgetsController = BudgetsController = __decorate([
    (0, common_1.Controller)('accounting/budgets'),
