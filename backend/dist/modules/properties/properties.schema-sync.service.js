...
var PropertiesSchemaSyncService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PropertiesSchemaSyncService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("typeorm");
let PropertiesSchemaSyncService = PropertiesSchemaSyncService_1 = class PropertiesSchemaSyncService {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.logger = new common_1.Logger(PropertiesSchemaSyncService_1.name);
    }
    async onModuleInit() {
      ...
      `);
        ...
        END $body$;
      `);
            await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_properties_project_id ON properties (project_id);`);
            await queryRunner.query(`
        DO $$
        BEGIN
          IF NOT EXISTS (
      ...
      `);
            ...
            for (const column of jsonColumns) {
                const columnInfo = await queryRunner.query(`SELECT udt_name FROM information_schema.columns WHERE table_schema = current_schema() AND table_name = 'properties' AND column_name = $1`, [column]);
                const udtName = columnInfo?.[0]?.udt_name;
                if (udtName && udtName !== 'jsonb') {
                    await queryRunner.query(`ALTER TABLE properties ALTER COLUMN ${column} TYPE jsonb USING CASE WHEN ${column} IS NULL THEN NULL ELSE to_jsonb(${column}) END;`);
                }
            }
            ...
            this.logger.error('Failed to synchronize properties table schema', error);
        }
        finally {
...
exports.PropertiesSchemaSyncService = PropertiesSchemaSyncService;
exports.PropertiesSchemaSyncService = PropertiesSchemaSyncService = PropertiesSchemaSyncService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], PropertiesSchemaSyncService);
//# sourceMappingURL=properties.schema-sync.service.js.map